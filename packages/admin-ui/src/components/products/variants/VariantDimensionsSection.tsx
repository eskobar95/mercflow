...
export function VariantDimensionsSection({ draft, update }: Props): ReactNode {
  return (
    <EditorSection title="Dimensions & customs" description="Used for shipping rates and customs declarations.">
