    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "developers",
            handle: { title: "Developers" } satisfies AppRouteHandle,
            lazy: async () => {
              const { DevelopersSettingsPage } = await import(
                "@/pages/settings/developers/DevelopersSettingsPage"
              )
              return { Component: DevelopersSettingsPage }
            },
          },
          {
            path: "connectors/gtm",
